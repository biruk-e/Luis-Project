...
st.write("Luis Project Temp. Website")
file = st.file_uploader("Upload your gilt data as a txt or csv file", type=['txt','csv'], accept_multiple_files=False, key=None, help=None, on_change=None, args=None, kwargs=None, disabled=False, label_visibility="visible")
